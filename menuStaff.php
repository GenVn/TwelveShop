...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0099ff;">
    <a class="navbar-brand" href="/TwelveShop/NhanVien">MILD STORE STAFF</a>
    ...
    <div>
      ...
      if (isset($_SESSION['staff'])) {
        echo '<a href="/TwelveShop/NhanVien/DangXuat" style="float: right;">
        ...
        echo '<a href="/TwelveShop/NhanVien/DangNhap" style="float: right;">
