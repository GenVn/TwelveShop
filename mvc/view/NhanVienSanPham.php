...
<body>
    ...
    <script>
        ...
        function requestAddProduct(){
            ...
            window.location.href="/TwelveShop/NhanVien/BaoCaoYeuCauThemSanPham"
        }
    </script>
