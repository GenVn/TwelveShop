...
<body>
    ...
    <div style="width: 80%;margin-left: 10%;">
        <a href="/TwelveShop/Admin/ThemPhieuNhap"><button type="button" class="btn btn-primary">Thêm Phiếu Nhập Kho</button></a>
        <a href="/TwelveShop/Admin/PhieuXuatKho"><button type="button" class="btn btn-primary">Phiếu Xuất Kho</button></a>
